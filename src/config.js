export const MODEL_PATH = '/gesture_recognizer.task';
...
export const PART_ORDER = ['body', 'top', 'bottom', 'shoes', 'nose', 'eyes'];

export const DISPLAY_ORDER = ['body', 'bottom', 'top', 'shoes', 'nose', 'eyes'];
